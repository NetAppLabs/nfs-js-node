...
export class JsNfsDirectoryHandleEntries {
  [Symbol.iterator](): Iterator<Array<any>, undefined, undefined>
}
export class JsNfsDirectoryHandleKeys {
  [Symbol.iterator](): Iterator<string, undefined, undefined>
}
export class JsNfsDirectoryHandleValues {
  [Symbol.iterator](): Iterator<JsNfsDirectoryHandle | JsNfsFileHandle, undefined, undefined>
}
